...
class SubjectiveGptTradingRobotDataSource(SubjectiveDataSource):
    connection_type = "GPT"
    connection_fields = ["model", "prompt_template", "api_key"]
    ...
    def fetch(self):
        ...
        self._emit_result({
            ...
            "prompt_template": self._get_param("prompt_template"),
            "status": "gpt_robot_placeholder",
        })
